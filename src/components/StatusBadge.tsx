...
export default function StatusBadge({ status }: Props) {
  ...
  if (status === 'COMMITTED') return <motion.span layout className="badge committed" initial={{opacity:0,scale:.92}} animate={{opacity:1,scale:1}}><Clock3/>Contratado</motion.span>
